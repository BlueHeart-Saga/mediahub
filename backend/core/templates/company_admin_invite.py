def build_company_admin_invite_email(company_name: str, name: str, otp: str, frontend_url: str) -> str:
    return f"""
    <!DOCTYPE html>
    <html>
    <head>
    ...
    <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
        <div style="background-color: #f8f9fa; border-radius: 10px; padding: 30px; border: 1px solid #e9ecef;">
            ...
            <p>You have been invited to become an administrator for <strong>{company_name}</strong>.</p>
