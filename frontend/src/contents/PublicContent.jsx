// ContentView.jsx - Public content view page
...
export default function ContentView() {
  ...
  const loadContent = async () => {
    ...
    try {
      setLoading(true);
      const res = await publicFetch(`/public/content/${contentId}`);
      setContent(res?.item || res);
      setLikeCount(res?.item?.stats?.likes || 0);
    } catch (error) {
  ...
  const loadComments = async () => {
    ...
    try {
      const res = await publicFetch(`/public/content/${contentId}/comments`);
  ...
  const loadRelatedContent = async () => {
    try {
      if (!content?.company_id || !content?.section?.slug) return;
  ...
  const handleLike = async () => {
    ...
    try {
      await publicFetch(`/public/content/${contentId}/like`, { method: "POST" });
      setLiked(!liked);
  ...
  const handleAddComment = async (e) => {
    ...
    try {
      ...
      await publicFetch(`/public/content/${contentId}/comments`, {
        method: "POST",
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex items-center space-x-6">
              ...
              <Link to="/about" className="text-gray-600 hover:text-[#111827] transition-colors">
                About
              </Link>
            </div>
      ...
      <div className="border-b border-gray-200 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-2 text-sm py-3 flex-wrap">
